...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ((() => {
  let projects = { inbox: (0,_project_factory_js__WEBPACK_IMPORTED_MODULE_1__["default"])("inbox") };
  ...
  const addToDo = (projectName, title, description, dueDate, priority) => {
    projects[projectName].getToDos().splice(
      0,
      0,
      (0,_todo_factory_js__WEBPACK_IMPORTED_MODULE_0__["default"])(title, description, dueDate, priority)
    );
  };
